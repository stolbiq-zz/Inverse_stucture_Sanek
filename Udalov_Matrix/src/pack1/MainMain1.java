	...
	public static void main(String[] args){
		try{
			...
			if ((ob1.getStr() == 1) || (ob1.getCol() == 1)){
				signal1 = "Vector";
				System.out.println("Vector has been read from textA.txt");
			}
			else {
				signal1 = "Matrix";
				System.out.println("Matrix has been read from textA.txt!");
			}
			
			if ((ob2.getStr() == 1) || (ob2.getCol() == 1)){
				signal2 = "Vector";
				System.out.println("Vector has been read from textB.txt");
			}
			else {
				signal2 = "Matrix";
				System.out.println("Matrix has been read from textB.txt!");
			}
