...
public class Tetragon extends JPanel implements MouseListener, MouseMotionListener {
...
Edge[] edges;
Start start;
public Tetragon(Start arg, Window1 arg2){
...
public void drawWireframe( Graphics g ) {
   ...
   g.drawString("Tetragonal Structure", 5 , 15);
