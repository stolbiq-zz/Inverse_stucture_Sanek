...
public class Trigon extends JPanel implements MouseListener, MouseMotionListener {
...
public Trigon(){
	   ...
	   vertices[0] = new Point3D( -0.5, -0.5, -1 );
	   vertices[1] = new Point3D( -0.5, -0.5,  1 );
	   vertices[2] = new Point3D( -1,  1, -1 );
	   vertices[3] = new Point3D( -1,  1,  1 );
	   vertices[4] = new Point3D(  1, -1, -1 );
	   vertices[5] = new Point3D(  1, -1,  1 );
	   vertices[6] = new Point3D(  0.5,  0.5, -1 );
	   vertices[7] = new Point3D(  0.5,  0.5,  1 );
...
public void drawWireframe( Graphics g ) {
   ...
   g.drawString("Trigonal Structure", 5 , 15);
